...
const FibonacciSearchViz = () => {
  ...
  return (
    <div className="bg-white rounded-lg p-6 shadow-lg text-gray-700">
      <div className="flex flex-wrap gap-3 items-end mb-4 text-gray-700">
        <div>
      ...
      <div className="flex flex-wrap justify-center gap-1 text-[10px] text-gray-500">
        {array.map((_, index) => (<div key={index} className="w-10 text-center text-gray-700">[{index}]</div>))}
      </div>

      {steps.length>0 && (
        <div className="bg-gray-50 rounded p-3 mt-4 max-h-44 overflow-auto text-sm text-gray-600">
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 text-gray-700">
      <div className="container mx-auto px-4 py-12 text-gray-700">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-10 text-gray-700">
          <div className="bg-white rounded-lg p-6 shadow text-center text-gray-700"><Clock className="h-10 w-10 text-indigo-600 mx-auto mb-2"/><div className="font-semibold text-slate-800">Time</div><div className="text-2xl font-bold text-indigo-600">O(log n)</div></div>
          <div className="bg-white rounded-lg p-6 shadow text-center text-gray-700"><Cpu className="h-10 w-10 text-blue-600 mx-auto mb-2"/><div className="font-semibold text-slate-800">Space</div><div className="text-2xl font-bold text-blue-600">O(1)</div></div>
          <div className="bg-white rounded-lg p-6 shadow text-center text-gray-700"><Eye className="h-10 w-10 text-purple-600 mx-auto mb-2"/><div className="font-semibold text-slate-800">Divisions</div><div className="text-2xl font-bold text-purple-600">None</div></div>
          <div className="bg-white rounded-lg p-6 shadow text-center text-gray-700"><BookOpen className="h-10 w-10 text-emerald-600 mx-auto mb-2"/><div className="font-semibold text-slate-800">Prereq</div><div className="text-2xl font-bold text-emerald-600">Sorted</div></div>
        </div>
