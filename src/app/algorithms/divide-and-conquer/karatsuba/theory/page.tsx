  ...
  return <div className="min-h-screen bg-gradient-to-br from-lime-50 to-green-50">
    <div className="container mx-auto px-4 py-16 max-w-7xl">
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <Link href="/algorithms/divide-and-conquer/karatsuba/simulation" className="inline-flex items-center px-6 py-3 rounded-md bg-lime-600 text-white hover:bg-lime-700 text-sm font-semibold">Simulation</Link>
        {next? <Link href={`/algorithms/divide-and-conquer/${next.slug}/theory`} className="inline-flex items-center px-5 py-2.5 rounded-md bg-lime-600 text-white hover:bg-lime-700 text-xs font-semibold">{next.name}<ArrowRight className="h-4 w-4 ml-2"/></Link>: <span/>}
      </div>
    </div>
  </div>;
}
