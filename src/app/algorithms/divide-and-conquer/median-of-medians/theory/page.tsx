...
export default function MedianOfMediansTheory(){
  return <div className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-50 text-gray-700">
    <div className="container mx-auto px-4 py-16 max-w-7xl text-gray-700">
      ...
      {/* Complexity */}
      <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.55, delay:0.2}} className="grid lg:grid-cols-2 gap-10 mb-14 text-gray-700">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 text-gray-700">
          <h2 className="text-2xl font-bold text-slate-800 mb-5 flex items-center gap-2"><Lightbulb className="h-5 w-5 text-gray-700"/> Notes</h2>
