  ...
  return <div className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-50 text-gray-700">
    <div className="container mx-auto px-4 py-16 max-w-7xl text-gray-700">
      ...
      <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.55}} className="mb-14 text-gray-700">
        <Link href="/algorithms/divide-and-conquer" className="inline-flex items-center text-rose-600 hover:text-rose-700 mb-6"><ArrowLeft className="h-5 w-5 mr-2 text-gray-700"/>All Divide & Conquer</Link>
      ...
      <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.55, delay:0.15}} className="grid lg:grid-cols-2 gap-12 mb-20 text-gray-700">
        ...
        <div className="bg-rose-50 border border-rose-100 rounded-2xl p-8 text-gray-700">
...
function MetricCard({label,value,note}:{label:string; value:string; note:string;}){
  return <div className="bg-white rounded-2xl shadow-xl p-6 border border-rose-100 relative overflow-hidden text-gray-700">
    <div className="absolute inset-0 bg-gradient-to-br from-rose-50 to-transparent opacity-60 text-gray-700" />
