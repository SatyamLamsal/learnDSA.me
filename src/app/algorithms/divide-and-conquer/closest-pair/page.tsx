...
export default function ClosestPairOverview(){
  ...
  <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6}} className="mb-12 text-gray-700">
        <Link href="/algorithms/divide-and-conquer" className="inline-flex items-center text-sky-600 hover:text-sky-700 mb-6"><ArrowLeft className="h-5 w-5 mr-2 text-gray-700"/>All Divide & Conquer</Link>
      ...
      {/* Metrics */}
      <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6, delay:0.05}} className="grid md:grid-cols-3 gap-6 mb-14 text-gray-700">
      ...
      {/* Features */}
      <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6, delay:0.1}} className="bg-white rounded-2xl shadow-xl p-8 mb-14 text-gray-700">
        <h2 className="text-3xl font-bold text-slate-800 mb-8">Key Mechanics</h2>
        <div className="grid md:grid-cols-3 gap-8 text-gray-700">
          <Feature icon={<Ruler className="h-5 w-5 text-gray-700"/>} title="Geometric Pruning" color="bg-sky-600">Y-sorted strip caps neighbors to 7 candidates.</Feature>
          <Feature icon={<Radar className="h-5 w-5 text-gray-700"/>} title="Threshold Delta" color="bg-cyan-600">Best distance delta narrows mid region.</Feature>
          <Feature icon={<Layers className="h-5 w-5 text-gray-700"/>} title="Structured Merge" color="bg-teal-600">Merge-by-y keeps strip build linear.</Feature>
        </div>
      </motion.div>

      {/* Applications & Recurrence */}
      <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6, delay:0.15}} className="grid lg:grid-cols-2 gap-10 mb-14 text-gray-700">
