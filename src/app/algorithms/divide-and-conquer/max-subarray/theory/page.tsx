      ...
      <div className="grid gap-6">
        ...
        <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{delay:0.05,duration:0.5}} className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="mt-4 grid md:grid-cols-3 gap-3 text-xs">
              <div className="p-3 rounded-lg bg-amber-50 border border-amber-100 flex gap-2"><BinaryIcon className="h-4 w-4 text-amber-600"/><span><b>Cross Composition:</b> O(n) outward scans from midpoint.</span></div>
              <div className="p-3 rounded-lg bg-amber-50 border border-amber-100 flex gap-2"><Zap className="h-4 w-4 text-amber-600"/><span><b>Contrast:</b> Kadane avoids recursion via running prefix optimization.</span></div>
              <div className="p-3 rounded-lg bg-amber-50 border border-amber-100 flex gap-2"><Activity className="h-4 w-4 text-amber-600"/><span><b>Teaching Value:</b> Mirrors crossing logic used in closest pair & merges.</span></div>
            </div>
        </motion.div>
        ...
        <motion.div initial={{opacity:0,y:14}} animate={{opacity:1,y:0}} transition={{delay:0.3,duration:0.5}} className="flex justify-between items-center">
          ...
          <Link href="/algorithms/divide-and-conquer/max-subarray/simulation" className="px-6 py-2 rounded bg-amber-600 text-white hover:bg-amber-700">Simulation</Link>
