  ...
  return <div className="min-h-screen bg-gradient-to-br from-fuchsia-50 to-pink-50 text-gray-700">
    <div className="container mx-auto px-4 py-16 max-w-7xl text-gray-700">
      ...
      <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.55, delay:0.2}} className="flex flex-wrap gap-5 mb-10 text-gray-700">
        <Link href="/algorithms/divide-and-conquer/fft/theory" className="inline-flex items-center px-7 py-3.5 bg-fuchsia-600 text-black rounded-lg hover:bg-fuchsia-700 text-sm font-semibold shadow text-gray-300">Deep Theory</Link>
        <Link href="/algorithms/divide-and-conquer/fft/simulation" className="inline-flex items-center px-7 py-3.5 bg-pink-600 text-black rounded-lg hover:bg-pink-700 text-sm font-semibold shadow text-gray-300">Interactive Simulation</Link>
      </motion.div>
      ...
      <div className="flex justify-between items-center mt-4 text-gray-700">
        ...
        {next? <Link href={`/algorithms/divide-and-conquer/${next.slug}`} className="inline-flex items-center px-5 py-2.5 rounded-md bg-fuchsia-600 text-black hover:bg-fuchsia-700 text-xs font-semibold text-gray-300">{next.name}<ArrowRight className="h-4 w-4 ml-2 text-gray-700"/></Link>: <span/>}
      </div>
    </div>
  </div>;
}
