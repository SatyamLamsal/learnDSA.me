        ...
        <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{delay:0.05,duration:0.5}} className="bg-white rounded-2xl shadow-sm p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-sm text-slate-600">
            ...
            <div className="grid gap-3 text-xs">
              <div className="p-3 rounded-lg bg-amber-50 border border-amber-100 flex gap-2"><Layers className="h-4 w-4 text-amber-600"/><span><b>Partition Scan:</b> Maintains boundary i of ≤ pivot region; scans j and swaps qualifying elements forward.</span></div>
              <div className="p-3 rounded-lg bg-amber-50 border border-amber-100 flex gap-2"><Gauge className="h-4 w-4 text-amber-600"/><span><b>Cost per Level:</b> Each level touches every element once → O(n) work per level.</span></div>
              <div className="p-3 rounded-lg bg-amber-50 border border-amber-100 flex gap-2"><Zap className="h-4 w-4 text-amber-600"/><span><b>Randomization:</b> Probability of ≥90% skew repeatedly shrinks exponentially.</span></div>
            </div>
          </div>
        </motion.div>
...
function Property({label,value}:{label:string;value:string}){
  return <div className="p-3 rounded-lg bg-amber-50 border border-amber-100">
