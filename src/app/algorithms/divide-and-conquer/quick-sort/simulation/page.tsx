    ...
    <div className="container mx-auto px-4 py-10 max-w-7xl text-gray-700">
      ...
      <div className="grid gap-6 text-gray-700">
        ...
        <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{delay:0.05,duration:0.5}} className="bg-white rounded-2xl shadow-sm p-6 flex flex-wrap gap-6 items-end text-gray-700">
          ...
          <button onClick={()=> setPlaying(p=> !p)} className="inline-flex items-center px-5 py-2 rounded bg-amber-600 text-white hover:bg-amber-700 text-sm font-semibold shadow-sm">{playing? <Pause className="h-4 w-4 mr-2 text-gray-700"/>: <Play className="h-4 w-4 mr-2 text-gray-700"/>}{playing? 'Pause':'Play'}</button>
        ...
        <motion.div initial={{opacity:0,y:16}} animate={{opacity:1,y:0}} transition={{delay:0.25,duration:0.5}} className="flex justify-between items-center text-gray-700">
          ...
          <Link href="/algorithms/divide-and-conquer/quick-sort/theory" className="px-6 py-2 rounded bg-amber-600 text-white hover:bg-amber-700 text-gray-100">View Theory</Link>
