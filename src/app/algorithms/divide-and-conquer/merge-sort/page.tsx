...
function StatCard({icon:Icon,title,value,subtitle,color}:{icon:React.ComponentType<{className?: string}>; title:string; value:string; subtitle:string; color:string;}){
  return <div className="bg-white rounded-2xl shadow-xl p-7 text-center text-gray-700">
...
export default function MergeSortOverview(){
  return <div className="min-h-screen bg-gradient-to-br from-sky-50 to-blue-50 text-gray-700">
    <div className="container mx-auto px-4 py-16 max-w-7xl text-gray-700">
      ...
      <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.55}} className="mb-16 text-gray-700">
        <Link href="/algorithms/divide-and-conquer" className="inline-flex items-center text-sky-600 hover:text-sky-700 mb-7"><ArrowLeft className="h-5 w-5 mr-2 text-gray-700"/>Back to Divide & Conquer</Link>
  ...
  <p className="text-xl text-slate-600 max-w-5xl leading-relaxed">Stable divide-and-conquer sorting: split in halves until size 1, then perform linear merges level by level. Each element participates in log n merge passes giving deterministic O(n log n) time.</p>
      ...
      {/* Metrics */}
  <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.55, delay:0.05}} className="grid md:grid-cols-4 gap-8 mb-16 text-gray-700">
      ...
      {/* Mechanics / Stages */}
      <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{duration:0.55, delay:0.1}} className="bg-white rounded-2xl shadow-xl p-9 mb-14 text-gray-700">
        ...
        <div className="grid lg:grid-cols-2 gap-14 text-gray-700">
          <div>
            <h3 className="text-xl font-semibold text-slate-800 mb-5">Stages</h3>
            <ol className="space-y-6 text-slate-700 text-base">
              <li className="flex items-start text-gray-700"><span className="bg-sky-100 text-sky-800 rounded-full w-9 h-9 flex items-center justify-center text-sm font-bold mr-4 mt-0.5">1</span>Divide sequence into two halves recursively</li>
              <li className="flex items-start text-gray-700"><span className="bg-sky-100 text-sky-800 rounded-full w-9 h-9 flex items-center justify-center text-sm font-bold mr-4 mt-0.5">2</span>Reach base single-element segments (already sorted)</li>
              <li className="flex items-start text-gray-700"><span className="bg-sky-100 text-sky-800 rounded-full w-9 h-9 flex items-center justify-center text-sm font-bold mr-4 mt-0.5">3</span>Merge sibling sorted runs via two-pointer scan</li>
              <li className="flex items-start text-gray-700"><span className="bg-sky-100 text-sky-800 rounded-full w-9 h-9 flex items-center justify-center text-sm font-bold mr-4 mt-0.5">4</span>Ascend levels building larger sorted runs until full array</li>
            </ol>
          </div>
          <div>
            ...
            <ul className="space-y-5 text-base text-gray-700">
              <li className="flex items-start text-gray-700"><span className="text-sky-600 mr-3 text-xl leading-none">•</span><span className="text-slate-700">Predictable O(n log n) regardless of input ordering</span></li>
              <li className="flex items-start text-gray-700"><span className="text-sky-600 mr-3 text-xl leading-none">•</span><span className="text-slate-700">Stable: equal keys keep original relative order</span></li>
              <li className="flex items-start text-gray-700"><span className="text-sky-600 mr-3 text-xl leading-none">•</span><span className="text-slate-700">Good for linked lists (can merge in-place with pointers)</span></li>
              <li className="flex items-start text-gray-700"><span className="text-sky-600 mr-3 text-xl leading-none">•</span><span className="text-slate-700">External merge (k-way) scales to large disk datasets</span></li>
            </ul>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{duration:0.55, delay:0.15}} className="grid lg:grid-cols-2 gap-8 mb-14 text-gray-700">
        <div className="bg-white rounded-2xl shadow-xl p-7 text-gray-700">
      ...
      {/* Notes */}
  <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{duration:0.55, delay:0.2}} className="bg-white rounded-2xl shadow-xl p-9 mb-14 text-gray-700">
        <div className="flex gap-6 items-start text-gray-700">
