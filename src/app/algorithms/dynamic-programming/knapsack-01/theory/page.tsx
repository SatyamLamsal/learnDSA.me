    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white p-6 rounded-lg shadow text-center"><Grid2x2 className="h-10 w-10 text-indigo-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">State</h3><p className="text-xs text-slate-600">dp[i][w] best value using first i items</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center"><Layers className="h-10 w-10 text-green-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Transition</h3><p className="text-xs text-slate-600">take vs skip item i-1</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center"><BookOpen className="h-10 w-10 text-purple-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Compression</h3><p className="text-xs text-slate-600">1D array backward iterate</p></div>
        </div>
