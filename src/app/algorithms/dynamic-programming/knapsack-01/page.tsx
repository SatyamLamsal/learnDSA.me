    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 text-white">
      <div className="container mx-auto px-4 py-14 text-gray-700">
        ...
        <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{duration:0.6, delay:0.05}} className="grid md:grid-cols-5 gap-6 mb-14 text-gray-700">
          <div className="bg-white rounded-lg shadow p-6 text-center text-gray-700"><Clock className="h-10 w-10 text-indigo-600 mx-auto mb-3"/><h3 className="font-semibold text-slate-800 mb-1">Time</h3><div className="text-xl font-bold text-indigo-600">O(n×W)</div><p className="text-[11px] text-slate-600 mt-1">n items</p></div>
          <div className="bg-white rounded-lg shadow p-6 text-center text-gray-700"><Cpu className="h-10 w-10 text-green-600 mx-auto mb-3"/><h3 className="font-semibold text-slate-800 mb-1">Space</h3><div className="text-xl font-bold text-green-600">O(n×W)</div><p className="text-[11px] text-slate-600 mt-1">or O(W)</p></div>
          <div className="bg-white rounded-lg shadow p-6 text-center text-gray-700"><Zap className="h-10 w-10 text-purple-600 mx-auto mb-3"/><h3 className="font-semibold text-slate-800 mb-1">Pattern</h3><div className="text-sm font-bold text-purple-600">Binary Choice</div></div>
          <div className="bg-white rounded-lg shadow p-6 text-center text-gray-700"><Grid2x2 className="h-10 w-10 text-orange-600 mx-auto mb-3"/><h3 className="font-semibold text-slate-800 mb-1">State</h3><div className="text-sm font-bold text-orange-600">dp[i][w]</div></div>
          <div className="bg-white rounded-lg shadow p-6 text-center text-gray-700"><BookOpen className="h-10 w-10 text-rose-600 mx-auto mb-3"/><h3 className="font-semibold text-slate-800 mb-1">Variants</h3><div className="text-xs font-semibold text-rose-600 leading-tight">Unbounded<br/>Multiple Constraints<br/>Subset Sum</div></div>
        </motion.div>
