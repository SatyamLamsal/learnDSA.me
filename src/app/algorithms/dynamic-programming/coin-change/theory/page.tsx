    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 text-gray-700">
      <div className="container mx-auto px-4 py-12 text-gray-700">
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6}} className="mb-10 text-gray-700">
          <Link href="/algorithms/dynamic-programming/coin-change" className="inline-flex items-center text-orange-600 hover:text-orange-700 mb-6"><ArrowLeft className="h-5 w-5 mr-2 text-gray-700"/>Back to Overview</Link>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12 text-gray-700">
          <div className="bg-white p-6 rounded-lg shadow text-center text-gray-700"><Coins className="h-10 w-10 text-orange-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">State</h3><p className="text-xs text-slate-600">dp[a] = min coins to form a</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center text-gray-700"><Layers className="h-10 w-10 text-green-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Transition</h3><p className="text-xs text-slate-600">dp[a] = min(dp[a-c]+1)</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center text-gray-700"><Sigma className="h-10 w-10 text-purple-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Counting Variant</h3><p className="text-xs text-slate-600">Add ways via accumulation</p></div>
        </div>
