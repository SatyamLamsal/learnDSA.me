    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-emerald-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white p-6 rounded-lg shadow text-center"><Scissors className="h-10 w-10 text-teal-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">State</h3><p className="text-xs text-slate-600">dp[i] cuts</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center"><BookOpen className="h-10 w-10 text-green-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Pal Table</h3><p className="text-xs text-slate-600">pal[i][j] bool</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center"><BookOpen className="h-10 w-10 text-purple-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Transition</h3><p className="text-xs text-slate-600">min over j</p></div>
        </div>
