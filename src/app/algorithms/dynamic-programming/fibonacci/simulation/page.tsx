    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50">
      <div className="container mx-auto px-4 py-12">
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6}} className="mb-8">
          <Link href="/algorithms/dynamic-programming/fibonacci" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-6"><ArrowLeft className="h-5 w-5 mr-2"/>Back to Fibonacci</Link>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-10">
          <div className="bg-white rounded-lg shadow p-6 text-center"><Clock className="h-10 w-10 text-blue-600 mx-auto mb-3"/><h3 className="font-semibold text-slate-800 mb-1">Time</h3><div className="text-xl font-bold text-blue-600">O(n)</div></div>
          <div className="bg-white rounded-lg shadow p-6 text-center"><Cpu className="h-10 w-10 text-green-600 mx-auto mb-3"/><h3 className="font-semibold text-slate-800 mb-1">Space</h3><div className="text-xl font-bold text-green-600">O(1–n)</div></div>
          <div className="bg-white rounded-lg shadow p-6 text-center"><Zap className="h-10 w-10 text-purple-600 mx-auto mb-3"/><h3 className="font-semibold text-slate-800 mb-1">Methods</h3><div className="text-sm font-bold text-purple-600">Tabulation / Rolling</div></div>
          <div className="bg-white rounded-lg shadow p-6 text-center"><Layers className="h-10 w-10 text-orange-600 mx-auto mb-3"/><h3 className="font-semibold text-slate-800 mb-1">Recurrence</h3><div className="text-sm font-bold text-orange-600">F(n)=F(n-1)+F(n-2)</div></div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-10">
          <div className="flex flex-wrap items-end gap-4 mb-6">
            ...
            <button onClick={run} disabled={running} className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded disabled:opacity-50">{running? 'Running…' : 'Run'}</button>
          </div>
          ...
          {steps.length>0 && (
            <div className="mt-6 max-h-44 overflow-y-auto text-[11px] bg-gray-50 p-3 rounded border font-mono space-y-1">
