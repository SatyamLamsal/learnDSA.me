...
export default function FibonacciTheoryPage(){
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white p-6 rounded-lg shadow flex flex-col items-center text-center"><BookOpen className="h-10 w-10 text-blue-600 mb-3"/><h3 className="font-semibold mb-1 text-slate-800">Definition</h3><p className="text-sm text-slate-600">F(0)=0, F(1)=1, F(n)=F(n-1)+F(n-2)</p></div>
          <div className="bg-white p-6 rounded-lg shadow flex flex-col items-center text-center"><Timer className="h-10 w-10 text-green-600 mb-3"/><h3 className="font-semibold mb-1 text-slate-800">Goal</h3><p className="text-sm text-slate-600">Compute F(n) efficiently for large n.</p></div>
          <div className="bg-white p-6 rounded-lg shadow flex flex-col items-center text-center"><Brain className="h-10 w-10 text-purple-600 mb-3"/><h3 className="font-semibold mb-1 text-slate-800">DP Insight</h3><p className="text-sm text-slate-600">Reuse overlapping subproblem results.</p></div>
        </div>
  ...
  return b;                // F(n)
          ...
          <article className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 p-4 rounded">
