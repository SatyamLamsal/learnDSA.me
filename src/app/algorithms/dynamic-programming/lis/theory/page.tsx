    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-rose-50 text-gray-700">
      <div className="container mx-auto px-4 py-12 text-gray-700">
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6}} className="mb-10 text-gray-700">
          <Link href="/algorithms/dynamic-programming/lis" className="inline-flex items-center text-red-600 hover:text-red-700 mb-6"><ArrowLeft className="h-5 w-5 mr-2 text-gray-700"/>Back to Overview</Link>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12 text-gray-700">
          <div className="bg-white p-6 rounded-lg shadow text-center text-gray-700"><ListOrdered className="h-10 w-10 text-red-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">O(n²) DP</h3><p className="text-xs text-slate-600">dp[i] = LIS ending at i</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center text-gray-700"><BookOpen className="h-10 w-10 text-green-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Optimized</h3><p className="text-xs text-slate-600">Binary search piles</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center text-gray-700"><BookOpen className="h-10 w-10 text-purple-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Reconstruction</h3><p className="text-xs text-slate-600">Track parents</p></div>
        </div>
