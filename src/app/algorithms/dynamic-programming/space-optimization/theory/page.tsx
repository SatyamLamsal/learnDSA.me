    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-slate-100 text-gray-700">
      <div className="container mx-auto px-4 py-12 text-gray-700">
        <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{duration:0.6}} className="mb-10 text-gray-700">
          <Link href="/algorithms/dynamic-programming/space-optimization" className="inline-flex items-center text-slate-700 hover:text-slate-900 mb-6"><ArrowLeft className="h-5 w-5 mr-2 text-gray-700"/>Back to Overview</Link>
        ...
        <div className="grid md:grid-cols-5 gap-4 mb-12 text-center text-gray-700">
          <div className="bg-white p-4 rounded shadow text-gray-700"><Layers className="h-8 w-8 text-blue-600 mx-auto mb-1"/><div className="text-xs font-medium text-gray-600">Rolling</div></div>
          <div className="bg-white p-4 rounded shadow text-gray-700"><MemoryStick className="h-8 w-8 text-green-600 mx-auto mb-1"/><div className="text-xs font-medium text-gray-600">Bitmask</div></div>
          <div className="bg-white p-4 rounded shadow text-gray-700"><HardDrive className="h-8 w-8 text-purple-600 mx-auto mb-1"/><div className="text-xs font-medium text-gray-600">Prefix</div></div>
          <div className="bg-white p-4 rounded shadow text-gray-700"><Cpu className="h-8 w-8 text-orange-600 mx-auto mb-1"/><div className="text-xs font-medium text-gray-600">Window</div></div>
          <div className="bg-white p-4 rounded shadow text-gray-700"><Clock className="h-8 w-8 text-rose-600 mx-auto mb-1"/><div className="text-xs font-medium text-gray-600">Closed Form</div></div>
        </div>
