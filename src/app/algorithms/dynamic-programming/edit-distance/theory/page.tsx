    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 text-white">
      <div className="container mx-auto px-4 py-12 text-gray-700">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12 text-gray-700">
          <div className="bg-white p-6 rounded-lg shadow text-center text-gray-700"><Replace className="h-10 w-10 text-indigo-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">State</h3><p className="text-xs text-slate-600">dp[i][j] distance</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center text-gray-700"><BookOpen className="h-10 w-10 text-green-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Base</h3><p className="text-xs text-slate-600">dp[i][0]=i dp[0][j]=j</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center text-gray-700"><BookOpen className="h-10 w-10 text-purple-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Transitions</h3><p className="text-xs text-slate-600">match/insert/delete/replace</p></div>
        </div>
