    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-fuchsia-50">
      <div className="container mx-auto px-4 py-12">
        <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{duration:0.6}} className="mb-10">
          <Link href="/algorithms/dynamic-programming/matrix-chain" className="inline-flex items-center text-pink-600 hover:text-pink-700 mb-6"><ArrowLeft className="h-5 w-5 mr-2"/>Back to Overview</Link>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white p-6 rounded-lg shadow text-center"><Brackets className="h-10 w-10 text-pink-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">State</h3><p className="text-xs text-slate-600">dp[i][j] cost</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center"><BookOpen className="h-10 w-10 text-green-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Transition</h3><p className="text-xs text-slate-600">min over k</p></div>
          <div className="bg-white p-6 rounded-lg shadow text-center"><BookOpen className="h-10 w-10 text-purple-600 mx-auto mb-2"/><h3 className="font-semibold text-slate-800 mb-1">Reconstruct</h3><p className="text-xs text-slate-600">store k*</p></div>
        </div>
