      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-10">
          <div className="flex flex-wrap gap-4 mb-4 items-end">
            ...
            <button onClick={run} disabled={running} className="bg-pink-600 hover:bg-pink-700 text-white px-4 py-2 rounded disabled:opacity-50">{running? 'Running...' : 'Run'}</button>
          </div>
          <div className="space-y-2 text-xs max-h-[340px] overflow-y-auto pr-2">
