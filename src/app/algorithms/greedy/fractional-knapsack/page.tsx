      ...
      <div className="container mx-auto px-4 py-12 text-gray-700">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8 text-gray-700">
          <div className="flex flex-wrap items-end gap-3 mb-4 text-gray-700">
            ...
            <button onClick={run} disabled={running} className="bg-amber-600 hover:bg-amber-700 text-black px-4 py-2 rounded inline-flex items-center disabled:opacity-50 text-black text-black text-black text-black"><Play className="h-4 w-4 mr-2 text-gray-700"/>Run</button>
