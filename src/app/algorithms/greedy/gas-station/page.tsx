  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-emerald-50">
      <div className="container mx-auto px-4 py-12">
        <Link href="/algorithms/greedy" className="inline-flex items-center text-emerald-600 hover:text-emerald-700 mb-6"><ArrowLeft className="h-5 w-5 mr-2"/>Back to Greedy</Link>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-4 border rounded">
              <div className="text-sm text-slate-700">Start index: <span className="font-semibold">{start}</span></div>
              <div className="text-sm text-slate-700">Running surplus: <span className="font-semibold">{surplus}</span></div>
              <div className="text-sm text-slate-700">Total (sum diffs): <span className="font-semibold">{total}</span></div>
              <div className="mt-3 h-3 bg-gray-100 rounded overflow-hidden"><motion.div className="h-3 bg-emerald-500" initial={{width:'0%'}} animate={{width: `${Math.max(0, Math.min(100, (surplus+20)/40*100))}%`}}/></div>
