  ...
  <div className="container max-w-screen-2xl mx-auto px-4 py-12">
      <motion.div initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:0.6}} className="mb-10">
        ...
        <h1 className="text-4xl font-bold text-slate-800 mb-4 flex items-center gap-3">
          <span className="inline-flex items-center justify-center h-14 w-14 rounded-2xl bg-amber-500 text-white shadow">
...
function Card({children}:{children:React.ReactNode}){ return <motion.div initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{duration:0.35}} className="bg-white rounded-2xl shadow-sm border border-amber-100 p-6">{children}</motion.div>; }
  ...
  return <Card>
    ...
    <div className="overflow-x-auto">
      <table className="text-xs w-full border border-slate-200">
        <thead className="bg-slate-100 text-slate-700"><tr><th className="p-2 text-left font-semibold">Method</th><th className="p-2 text-left font-semibold">Mechanism</th><th className="p-2 text-left font-semibold">Cycle Signal</th><th className="p-2 text-left font-semibold">Stability</th></tr></thead>
        <tbody className="divide-y divide-slate-200">
          <tr className="hover:bg-amber-50/40"><td className="p-2 font-mono">Kahn</td><td className="p-2">Queue of in-degree 0</td><td className="p-2">Remaining vertices</td><td className="p-2">Depends on queue order</td></tr>
          <tr className="hover:bg-amber-50/40"><td className="p-2 font-mono">DFS</td><td className="p-2">Reverse finish times</td><td className="p-2">Back edge</td><td className="p-2">Depends on DFS order</td></tr>
        </tbody>
      </table>
    </div>
  </Card>;
...
function NavigationCard(){
  return <Card>
    ...
    <div className="flex flex-col gap-3">
      <Link href="/algorithms/graph/topological-sort/theory" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-amber-600 text-white font-semibold hover:bg-amber-700">Theory <ArrowRight className="h-5 w-5 ml-2"/></Link>
      <Link href="/algorithms/graph/topological-sort/simulation" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-slate-800 text-white font-semibold hover:bg-slate-900">Simulation <ArrowRight className="h-5 w-5 ml-2"/></Link>
