...
function Navigation(){
  return <motion.div initial={{opacity:0,y:24}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{duration:0.5}} className="bg-white rounded-2xl shadow-sm border border-indigo-100 p-6 text-gray-700">
    ...
    <div className="flex flex-col gap-3 text-gray-800">
      <Link href="/algorithms/graph/floyd-warshall/simulation" className="inline-flex items-center justify-center px-5 py-3 rounded-lg bg-indigo-600 text-black font-semibold hover:bg-indigo-700 text-gray-800">Simulation <ArrowRight className="h-5 w-5 ml-2 text-gray-800"/></Link>
