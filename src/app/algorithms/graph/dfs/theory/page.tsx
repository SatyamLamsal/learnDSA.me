...
function Header(){
  return <motion.div initial={{opacity:0,y:25}} animate={{opacity:1,y:0}} className="mb-10">
    <Link href="/algorithms/graph/dfs" className="inline-flex items-center text-green-600 hover:text-green-700 mb-6"><ArrowLeft className="h-5 w-5 mr-2"/>Back to DFS Overview</Link>
...
const Complexity = ()=> <Card title="Time & Space Complexity"><div className="grid md:grid-cols-3 gap-4 text-sm"><div className="p-3 rounded-xl bg-green-50 border border-green-200"><div className="font-semibold text-green-700 text-[11px] uppercase tracking-wide">Time</div><div className="font-mono mt-1">O(V + E)</div></div><div className="p-3 rounded-xl bg-emerald-50 border border-emerald-200"><div className="font-semibold text-emerald-700 text-[11px] uppercase tracking-wide">Space</div><div className="font-mono mt-1">O(V)</div></div><div className="p-3 rounded-xl bg-lime-50 border border-lime-200"><div className="font-semibold text-lime-700 text-[11px] uppercase tracking-wide">Recursion Depth</div><div className="font-mono mt-1">O(h) ≤ O(V)</div></div></div><p className="text-xs text-slate-600 mt-4">Each vertex discovered and finished once; each edge examined at most twice (undirected) or once (directed).</p></Card>;
