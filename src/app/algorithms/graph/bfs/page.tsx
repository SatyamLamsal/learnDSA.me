...
export default function BFSOverviewPage(){
  ...
  <div className="container mx-auto px-4 py-12 max-w-screen-2xl">
        ...
        <motion.div initial={{opacity:0,y:25}} animate={{opacity:1,y:0}} transition={{delay:0.15}} className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              ...
              <div className="flex flex-col gap-3">
                <Link href="/algorithms/graph/bfs/theory" className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-colors">
                  <BookOpen className="h-5 w-5"/> Dive into Theory
                </Link>
                <Link href="/algorithms/graph/bfs/simulation" className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-green-600 text-white font-semibold hover:bg-green-700 transition-colors">
                  <Play className="h-5 w-5"/> Try Simulation
                </Link>
              </div>
            </div>
          </div>
        ...
        <motion.div
  initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="flex justify-end items-center">
  <Link href="/algorithms/graph/dfs" className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
    Next: DFS <ArrowRight className="h-5 w-5 ml-2" /></Link>
</motion.div>
