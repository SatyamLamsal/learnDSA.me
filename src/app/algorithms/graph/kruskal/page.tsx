...
function Card({children}:{children:React.ReactNode}){ return <motion.div initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{duration:0.35}} className="bg-white rounded-2xl shadow-sm border border-indigo-100 p-6">{children}</motion.div>; }
  ...
  return <Card>
    ...
    <div className="overflow-x-auto">
      <table className="text-xs w-full border border-slate-200">
        <thead className="bg-slate-100 text-slate-700"><tr><th className="p-2 text-left font-semibold">Algorithm</th><th className="p-2 text-left font-semibold">Best For</th><th className="p-2 text-left font-semibold">Approach</th><th className="p-2 text-left font-semibold">Time</th></tr></thead>
        <tbody className="divide-y divide-slate-200">
          <tr className="hover:bg-indigo-50/40"><td className="p-2 font-mono">Prim (Heap)</td><td className="p-2">Dense graphs</td><td className="p-2">Grow tree</td><td className="p-2">O(m log n)</td></tr>
          <tr className="hover:bg-indigo-50/40"><td className="p-2 font-mono font-semibold text-indigo-700">Kruskal</td><td className="p-2">Sparse / Edge-sorted reuse</td><td className="p-2">Merge forests</td><td className="p-2">O(m log n)</td></tr>
          <tr className="hover:bg-indigo-50/40"><td className="p-2 font-mono">Borůvka</td><td className="p-2">Parallelizable</td><td className="p-2">Component merges</td><td className="p-2">O(m log n)</td></tr>
        </tbody>
      </table>
    </div>
  </Card>;
...
function NavigationCard(){
  return <Card>
    ...
    <div className="flex flex-col gap-3">
      <Link href="/algorithms/graph/kruskal/theory" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-indigo-600 text-white font-semibold hover:bg-indigo-700">Theory <ArrowRight className="h-5 w-5 ml-2"/></Link>
      <Link href="/algorithms/graph/kruskal/simulation" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-slate-800 text-white font-semibold hover:bg-slate-900">Simulation <ArrowRight className="h-5 w-5 ml-2"/></Link>
