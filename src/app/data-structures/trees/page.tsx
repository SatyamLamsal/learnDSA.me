    ...
    <div className="bg-white rounded-lg p-6 shadow-lg">
      <div className="flex flex-col items-center">
        ...
        <motion.div
          ...
          className="w-12 h-12 bg-purple-500 text-white rounded-full flex items-center justify-center font-bold mb-4"
        >
          50
        </motion.div>
        ...
        <div className="flex items-center space-x-16 mb-4">
          <motion.div
            ...
            className="w-12 h-12 bg-purple-500 text-white rounded-full flex items-center justify-center font-bold"
          >
            30
          </motion.div>
          <motion.div
        ...
        <div className="flex items-center space-x-8 mb-4">
          <motion.div
            ...
            className="w-10 h-10 bg-purple-400 text-white rounded-full flex items-center justify-center font-bold text-sm"
          >
            20
          </motion.div>
          <motion.div
...
export default function TreesPage() {
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-purple-500 pl-4">
                <h4 className="font-semibold">Root</h4>
                <p className="text-gray-600">The topmost node with no parent</p>
              </div>
              <div className="border-l-4 border-purple-500 pl-4">
                <h4 className="font-semibold">Leaf</h4>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-purple-500 pl-4">
                <h4 className="font-semibold">File Systems</h4>
                <p className="text-gray-600">Directory and file organization</p>
              </div>
              <div className="border-l-4 border-purple-500 pl-4">
                <h4 className="font-semibold">Database Indexing</h4>
                <p className="text-gray-600">B-trees for efficient database operations</p>
              </div>
              <div className="border-l-4 border-purple-500 pl-4">
                <h4 className="font-semibold">Expression Parsing</h4>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-purple-100">
                  <th className="border border-purple-300 px-4 py-3 font-semibold">Operation</th>
                  <th className="border border-purple-300 px-4 py-3 font-semibold">Average Case</th>
                  <th className="border border-purple-300 px-4 py-3 font-semibold">Worst Case</th>
                  <th className="border border-purple-300 px-4 py-3 font-semibold">Best Case</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-purple-300 px-4 py-3">Search</td>
                ...
                <tr className="bg-gray-50">
                  <td className="border border-purple-300 px-4 py-3">Insertion</td>
                  <td className="border border-purple-300 px-4 py-3 text-yellow-600 font-mono">O(log n)</td>
                  <td className="border border-purple-300 px-4 py-3 text-red-600 font-mono">O(n)</td>
                  <td className="border border-purple-300 px-4 py-3 text-green-600 font-mono">O(1)</td>
                </tr>
                <tr>
                  <td className="border border-purple-300 px-4 py-3">Deletion</td>
                  <td className="border border-purple-300 px-4 py-3 text-yellow-600 font-mono">O(log n)</td>
                  <td className="border border-purple-300 px-4 py-3 text-red-600 font-mono">O(n)</td>
                  <td className="border border-purple-300 px-4 py-3 text-green-600 font-mono">O(1)</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="border border-purple-300 px-4 py-3">Traversal</td>
  ...
  <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            <Link href="/data-structures/trees/theory" className="block bg-white rounded-lg border border-gray-100 shadow-lg p-8 hover:shadow-xl hover:border-purple-200 transition-all">
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.02 }}
          >
            <Link href="/data-structures/trees/simulation" className="block bg-white rounded-lg border border-gray-100 shadow-lg p-8 hover:shadow-xl hover:border-purple-200 transition-all">
              <div className="flex items-center justify-between mb-4">
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.02 }}
          >
            <Link href="/data-structures/trees/pseudocode" className="block bg-white rounded-lg border border-gray-100 shadow-lg p-8 hover:shadow-xl hover:border-purple-200 transition-all">
              <div className="flex items-center justify-between mb-4">
                <BookOpen className="h-8 w-8 text-purple-600" />
                <ArrowRight className="h-6 w-6 text-gray-400" />
              </div>
