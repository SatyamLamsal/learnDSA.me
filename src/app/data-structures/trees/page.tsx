    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <Link href="/data-structures/trees/theory" className="block bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-all">
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.02 }}
          >
            <Link href="/data-structures/trees/simulation" className="block bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-all">
              <div className="flex items-center justify-between mb-4">
