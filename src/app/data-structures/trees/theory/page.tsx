      ...
      <div className="relative h-80 bg-white rounded border text-gray-700">
        ...
        {nodes.map((node, index) => (
          <motion.div
            ...
            className="absolute w-10 h-10 bg-purple-500 text-white rounded-full flex items-center justify-center font-bold text-sm transform -translate-x-5 -translate-y-5 text-gray-600"
            ...
            <div className="grid md:grid-cols-2 gap-8 text-gray-700">
              ...
              <div>
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="bg-purple-50 p-3 rounded border-l-4 border-purple-500 text-gray-700">
      ...
      queue.push(node.right);
                ...
                <div className="bg-purple-50 p-6 rounded-lg border border-purple-200 text-gray-700">
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    ...
                    <div className="flex justify-between text-gray-700">
                      <span className="font-medium text-gray-600">Space Complexity:</span>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700">
                  <div className="bg-gray-50 p-4 rounded border text-gray-700">
                    <h4 className="font-semibold flex items-center mb-2 text-gray-800">
  ...
  return root;
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 text-gray-700">
              <div className="bg-red-50 p-6 rounded-lg border border-red-200 text-gray-700">
                ...
                <div className="space-y-3 text-sm text-gray-600">
                  ...
                  <div className="bg-red-100 p-3 rounded text-gray-700">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8 text-gray-700">
              <div>
                <h3 className="text-xl font-semibold mb-4 text-gray-800">Time Complexity</h3>
                <div className="bg-white bg-opacity-20 rounded-lg p-4 text-gray-700">
                  <div className="grid grid-cols-3 gap-4 text-sm text-gray-600">
                    ...
                    <div className="font-semibold text-gray-800">Average</div>
                    <div className="font-semibold text-gray-800">Worst</div>
                    
                    <div>Search</div>
                    <div className="font-mono text-gray-700">O(log n)</div>
                    <div className="font-mono text-gray-700">O(n)</div>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4 text-gray-800">Space Complexity</h3>
                <div className="bg-white bg-opacity-20 rounded-lg p-4 space-y-3 text-gray-700">
                  <div className="flex justify-between text-gray-700">
                    <span>Storage:</span>
                    <span className="font-mono text-gray-600">O(n)</span>
                  </div>
                  <div className="flex justify-between text-gray-700">
                    <span>Recursion (balanced):</span>
                    <span className="font-mono text-gray-600">O(log n)</span>
                  </div>
                  <div className="flex justify-between text-gray-700">
                    <span>Recursion (skewed):</span>
                    <span className="font-mono text-gray-600">O(n)</span>
                  </div>
                  <div className="text-sm mt-4 opacity-90 text-gray-600">
