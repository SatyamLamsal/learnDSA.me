...
export default function QueuesTheoryPage() {
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 flex items-center">
            <BookOpen className="h-6 w-6 text-queues mr-2" />
            Quick Navigation
          </h2>
          <div className="grid md:grid-cols-4 gap-4">
            <a href="#basics" className="flex items-center p-3 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors border border-yellow-200">
              <div className="w-2 h-2 bg-queues rounded-full mr-3"></div>
              <span className="text-gray-800 font-medium">FIFO Principle</span>
            </a>
            <a href="#types" className="flex items-center p-3 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors border border-yellow-200">
              <div className="w-2 h-2 bg-queues rounded-full mr-3"></div>
              <span className="text-gray-800 font-medium">Queue Types</span>
            </a>
            <a href="#operations" className="flex items-center p-3 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors border border-yellow-200">
              <div className="w-2 h-2 bg-queues rounded-full mr-3"></div>
              <span className="text-gray-800 font-medium">Operations</span>
            </a>
            <a href="#implementation" className="flex items-center p-3 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors border border-yellow-200">
              <div className="w-2 h-2 bg-queues rounded-full mr-3"></div>
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-3xl font-bold text-heading-primary mb-6 flex items-center">
              <Users className="h-8 w-8 text-queues mr-3" />
              Queue Fundamentals
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-heading-secondary mb-4">What is a Queue?</h3>
              ...
              <div className="bg-yellow-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-heading-secondary mb-4">Key Characteristics</h3>
                <div className="space-y-3">
                  <div className="flex items-center">
                    <Clock className="h-5 w-5 text-queues mr-2" />
                    <span className="text-secondary">O(1) enqueue and dequeue operations</span>
                  </div>
                  <div className="flex items-center">
                    <TrendingUp className="h-5 w-5 text-queues mr-2" />
                    <span className="text-secondary">FIFO ordering principle</span>
                  </div>
                  <div className="flex items-center">
                    <Zap className="h-5 w-5 text-queues mr-2" />
                    <span className="text-secondary">Efficient for sequential processing</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-3xl font-bold text-heading-primary mb-6 flex items-center">
              <Shuffle className="h-8 w-8 text-queues mr-3" />
              Types of Queues
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-heading-secondary mb-4">Linear Queue</h3>
                <p className="text-secondary mb-4">
              ...
              <div className="bg-green-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-heading-secondary mb-4">Circular Queue</h3>
                <p className="text-secondary mb-4">
              ...
              <div className="bg-purple-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-heading-secondary mb-4">Priority Queue</h3>
                <p className="text-secondary mb-4">
              ...
              <div className="bg-orange-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-heading-secondary mb-4">Double-Ended Queue (Deque)</h3>
                <p className="text-secondary mb-4">
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-3xl font-bold text-heading-primary mb-6 flex items-center">
              <Code className="h-8 w-8 text-queues mr-3" />
              Core Operations
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="border-l-4 border-queues pl-4">
                  <h3 className="text-lg font-semibold text-heading-secondary">Enqueue Operation</h3>
                  <p className="text-secondary mt-2">Add an element to the rear of the queue</p>
                ...
                <div className="border-l-4 border-queues pl-4">
                  <h3 className="text-lg font-semibold text-heading-secondary">Dequeue Operation</h3>
                  <p className="text-secondary mt-2">Remove and return element from the front</p>
                  <div className="bg-gray-50 p-3 rounded-lg mt-2">
                    <code className="text-sm">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-queues pl-4">
                  <h3 className="text-lg font-semibold text-heading-secondary">Front/Peek Operation</h3>
                  <p className="text-secondary mt-2">View the front element without removing it</p>
                  <div className="bg-gray-50 p-3 rounded-lg mt-2">
                    <code className="text-sm">
                ...
                <div className="border-l-4 border-queues pl-4">
                  <h3 className="text-lg font-semibold text-heading-secondary">isEmpty Operation</h3>
                  <p className="text-secondary mt-2">Check if the queue has no elements</p>
                  <div className="bg-gray-50 p-3 rounded-lg mt-2">
                    <code className="text-sm">
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-3xl font-bold text-heading-primary mb-6">Implementation Methods</h2>
            
            <div className="space-y-8">
              {/* Array Implementation */}
              <div className="bg-yellow-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-heading-secondary mb-4">Array Implementation (Circular Queue)</h3>
  ...
  isFull() {
    return this.size === this.capacity;
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-heading-secondary mb-4">Linked List Implementation</h3>
                <div className="bg-white p-4 rounded-lg mb-4 overflow-x-auto">
                  <pre className="text-sm">
                    <code>{`class Node {
  constructor(data) {
...
class LinkedQueue {
  ...
  isEmpty() {
    return this.front === null;
              ...
              <div className="bg-purple-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-heading-secondary mb-4">Priority Queue Implementation (Min-Heap)</h3>
                <div className="bg-white p-4 rounded-lg mb-4 overflow-x-auto">
                  <pre className="text-sm">
  ...
  isEmpty() {
    return this.heap.length === 0;
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-3xl font-bold text-heading-primary mb-6">Real-World Applications</h2>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">CPU Scheduling</h3>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">Breadth-First Search</h3>
                <p className="text-secondary text-sm mb-3">
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">Print Queue Management</h3>
                <p className="text-secondary text-sm mb-3">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-violet-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">Buffer for Data Streams</h3>
                <p className="text-secondary text-sm mb-3">
              ...
              <div className="bg-gradient-to-br from-red-50 to-pink-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">Task Scheduling</h3>
                <p className="text-secondary text-sm mb-3">
              ...
              <div className="bg-gradient-to-br from-teal-50 to-cyan-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">Web Server Request Handling</h3>
                <p className="text-secondary text-sm mb-3">
