...
import { ArrowLeft, ArrowRight, RotateCcw, Plus, Minus, Search, Code, BookOpen, Zap, Layers, TrendingUp, Clock } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 flex items-center">
            <BookOpen className="h-6 w-6 text-stacks mr-2" />
            Quick Navigation
          </h2>
          <div className="grid md:grid-cols-3 gap-4">
            <a href="#basics" className="flex items-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors border border-green-200">
              <div className="w-2 h-2 bg-stacks rounded-full mr-3"></div>
              <span className="text-gray-800 font-medium">LIFO Principle & Basics</span>
            </a>
            <a href="#operations" className="flex items-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors border border-green-200">
              <div className="w-2 h-2 bg-stacks rounded-full mr-3"></div>
              <span className="text-gray-800 font-medium">Core Operations</span>
            </a>
            <a href="#implementation" className="flex items-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors border border-green-200">
              <div className="w-2 h-2 bg-stacks rounded-full mr-3"></div>
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-3xl font-bold text-heading-primary mb-6 flex items-center">
              <Layers className="h-8 w-8 text-stacks mr-3" />
              Stack Fundamentals
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-heading-secondary mb-4">What is a Stack?</h3>
              ...
              <div className="bg-green-50 p-6 rounded-lg">
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    <Clock className="h-5 w-5 text-stacks mr-2" />
                    <span className="text-secondary">O(1) push and pop operations</span>
                  </div>
                  <div className="flex items-center">
                    <TrendingUp className="h-5 w-5 text-stacks mr-2" />
                    <span className="text-secondary">LIFO ordering principle</span>
                  </div>
                  <div className="flex items-center">
                    <Zap className="h-5 w-5 text-stacks mr-2" />
                    <span className="text-secondary">Memory efficient implementation</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-3xl font-bold text-heading-primary mb-6 flex items-center">
              <Code className="h-8 w-8 text-stacks mr-3" />
              Core Operations
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="border-l-4 border-stacks pl-4">
                  <h3 className="text-lg font-semibold text-heading-secondary">Push Operation</h3>
                  <p className="text-secondary mt-2">Add an element to the top of the stack</p>
                ...
                <div className="border-l-4 border-stacks pl-4">
                  <h3 className="text-lg font-semibold text-heading-secondary">Pop Operation</h3>
                  <p className="text-secondary mt-2">Remove and return the top element</p>
                  <div className="bg-gray-50 p-3 rounded-lg mt-2">
                    <code className="text-sm">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-stacks pl-4">
                  <h3 className="text-lg font-semibold text-heading-secondary">Peek/Top Operation</h3>
                  <p className="text-secondary mt-2">View the top element without removing it</p>
                  <div className="bg-gray-50 p-3 rounded-lg mt-2">
                    <code className="text-sm">
                ...
                <div className="border-l-4 border-stacks pl-4">
                  ...
                  <p className="text-secondary mt-2">Check if the stack has no elements</p>
                  <div className="bg-gray-50 p-3 rounded-lg mt-2">
                    <code className="text-sm">
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-green-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-heading-secondary mb-4">Array Implementation</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">Function Call Management</h3>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">Expression Evaluation</h3>
                <p className="text-secondary text-sm mb-3">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-violet-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">Undo Operations</h3>
                <p className="text-secondary text-sm mb-3">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">Browser History</h3>
                <p className="text-secondary text-sm mb-3">
              ...
              <div className="bg-gradient-to-br from-pink-50 to-rose-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">Parentheses Matching</h3>
                <p className="text-secondary text-sm mb-3">
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-blue-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-heading-secondary mb-3">Memory Management</h3>
                <p className="text-secondary text-sm mb-3">
