            ...
            return (
              ...
              >
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="bg-pink-500 text-white px-3 py-1 rounded font-bold">
                    {hash}
                  </span>
                </div>
              </motion.div>
        ...
        <div className="space-y-2">
          {buckets.map((bucket, index) => (
            ...
            >
              ...
              <div className="flex-1 min-h-12 bg-white rounded-lg border-2 border-dashed border-gray-300 flex items-center px-4">
                {bucket.length > 0 ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="font-mono bg-gray-100 p-2 rounded">h(k) = k mod m</div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="font-mono bg-gray-100 p-2 rounded text-xs">h(k) = ⌊m(kA mod 1)⌋</div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="font-mono bg-gray-100 p-2 rounded text-xs">h(k) = ((ak + b) mod p) mod m</div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="font-mono bg-gray-100 p-2 rounded text-xs">SHA-256, MD5</div>
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="space-y-2">
                        <div className="bg-green-100 p-3 rounded">
                          ...
                          <div className="font-mono text-xs">h&apos;(k) = (h(k) + i) mod m</div>
                        ...
                        <div className="bg-green-300 p-3 rounded">
                          ...
                          <div className="font-mono text-xs">h&apos;(k) = (h₁(k) + i×h₂(k)) mod m</div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="bg-yellow-500 text-white px-2 py-1 rounded text-xs">Acceptable</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span>α &gt; 1.0</span>
                        <span className="bg-red-500 text-white px-2 py-1 rounded text-xs">Poor</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <table className="w-full text-left border-collapse bg-gray-50 rounded-lg">
                    <thead>
                      <tr className="bg-pink-100">
                        <th className="border border-pink-300 px-3 py-2 font-semibold text-sm">Operation</th>
                        <th className="border border-pink-300 px-3 py-2 font-semibold text-sm">Average</th>
                        <th className="border border-pink-300 px-3 py-2 font-semibold text-sm">Worst</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="border border-pink-300 px-3 py-2 text-sm">Search</td>
                      ...
                      <tr className="bg-gray-50">
                        <td className="border border-pink-300 px-3 py-2 text-sm">Insert</td>
                        <td className="border border-pink-300 px-3 py-2 text-green-600 font-mono text-sm">O(1)</td>
                        <td className="border border-pink-300 px-3 py-2 text-red-600 font-mono text-sm">O(n)</td>
                      </tr>
                      <tr>
                        <td className="border border-pink-300 px-3 py-2 text-sm">Delete</td>
                        <td className="border border-pink-300 px-3 py-2 text-green-600 font-mono text-sm">O(1)</td>
                        <td className="border border-pink-300 px-3 py-2 text-red-600 font-mono text-sm">O(n)</td>
                      </tr>
                    </tbody>
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span>Chaining:</span>
                        <span className="font-mono">O(n + m)</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Open Addressing:</span>
                        <span className="font-mono">O(m)</span>
                      </div>
