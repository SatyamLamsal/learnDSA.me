...
const ThemeDemoPage: React.FC = () => {
  ...
  const features = [
    {
      icon: <Sun className="h-6 w-6 text-gray-700" />,
      title: 'Light Mode',
    ...
    {
      icon: <Monitor className="h-6 w-6 text-gray-700" />,
      title: 'System Sync',
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 text-gray-100">
      <div className="container mx-auto px-4 py-12 text-gray-700">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-200 dark:border-gray-700 text-gray-100"
        >
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <div className="flex justify-between text-gray-700">
                  ...
                  <div className="flex items-center space-x-2 text-gray-700">
                    <div 
                      className="w-4 h-4 rounded border text-gray-700" 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 text-gray-700">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow text-gray-100"
              >
                ...
                <div className="flex space-x-2 text-gray-700">
                  {feature.colors.map((color, colorIndex) => (
                    <div
                      key={colorIndex}
                      className="w-6 h-6 rounded-full border-2 border-white dark:border-gray-600 text-gray-700"
  ...
  {/* Color Palettes */}
        <div className="grid lg:grid-cols-2 gap-8 text-gray-700">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-gray-700 text-gray-100"
          >
            ...
            <div className="space-y-4 text-gray-700">
              {dataStructureColors.map((item, index) => (
                <motion.div
                  ...
                  className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg text-gray-100"
                >
                  ...
                  <div className="flex items-center space-x-3 text-gray-700">
                    <div
                      className="w-8 h-8 rounded-lg border-2 border-white dark:border-gray-600 shadow-sm text-gray-700"
        ...
        <motion.div
          ...
          className="mt-12 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-gray-700 text-gray-100"
        >
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
            Live Color Controls
          </h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 text-gray-700">
            {[
              ...
              <div key={item.var} className="p-4 rounded-lg border border-gray-200 dark:border-gray-700 text-gray-700">
          ...
          <div className="mt-6 flex justify-end text-gray-700">
            <button
        ...
        <motion.div
          ...
          className="mt-12 bg-blue-50 dark:bg-blue-900/20 rounded-xl p-8 border border-blue-200 dark:border-blue-800 text-gray-100"
        >
          <div className="flex items-center mb-4 text-gray-700">
          ...
          <div className="space-y-4 text-blue-800 dark:text-blue-200">
            <div>
              <h4 className="font-semibold mb-2 text-gray-800">1. Use the Theme Context</h4>
            ...
            <div>
              <h4 className="font-semibold mb-2 text-gray-800">2. Add Theme Toggle Component</h4>
              <div className="bg-blue-100 dark:bg-blue-900/40 p-4 rounded-lg font-mono text-sm text-gray-300">
