...
export default function FoundationsADTPage() {
  ...
  return (
    ...
    >
      ...
      {/* ADT Introduction */}
      <div id="introduction" className="bg-white rounded-2xl p-8 shadow-lg border mb-12 text-gray-700">
      ...
      {/* ADT Concepts */}
      <div id="concepts" className="bg-white rounded-2xl p-8 shadow-lg border mb-12 text-gray-700">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 text-gray-700">
          {adtConcepts.map((concept, index) => {
            ...
            return (
              <div key={index} className="bg-gray-50 p-6 rounded-xl border text-gray-700">
      ...
      <div id="array-example" className="bg-white rounded-2xl p-8 shadow-lg border mb-12 text-gray-700">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center">
...
index_type == integer`}
            ...
            <div className="space-y-3 text-gray-700">
              <div className="flex items-start space-x-3 text-gray-700">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800">Data Representation</h4>
              ...
              <div className="flex items-start space-x-3 text-gray-700">
                <CheckCircle className="w-5 h-5 text-green-500 mt-1" />
                <div>
                  <h4 className="font-semibold text-gray-800">Algorithm for Operations</h4>
        ...
        <div className="text-center text-gray-700">
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-8 py-4 rounded-xl shadow-lg text-gray-700">
            <div className="flex items-center text-gray-700">
              ...
              <span className="font-semibold text-lg text-gray-800">Foundations Complete!</span>
            </div>
