    ...
    >
      <div className="space-y-8 text-gray-700">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border text-gray-700">
          ...
          <div className="grid lg:grid-cols-2 gap-8 text-gray-700">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              {/* L1 Cache */}
              <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white p-4 rounded-xl ml-4 text-gray-700">
                <div className="flex items-center justify-between text-gray-700">
                  <div className="flex items-center space-x-3 text-gray-700">
                    <Zap className="w-6 h-6 text-gray-700" />
                    <div>
                      <h3 className="font-bold text-gray-800">L1 Cache</h3>
                      <p className="text-orange-100 text-sm">On-chip cache</p>
                    </div>
                  </div>
                  <div className="text-right text-sm text-gray-600">
                    <div className="font-mono text-gray-700">~3 cycles</div>
              ...
              {/* L2 Cache */}
              <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white p-4 rounded-xl ml-8 text-gray-700">
                <div className="flex items-center justify-between text-gray-700">
                  <div className="flex items-center space-x-3 text-gray-700">
                    <Zap className="w-6 h-6 text-gray-700" />
                    <div>
                      <h3 className="font-bold text-gray-800">L2 Cache</h3>
                      <p className="text-yellow-100 text-sm">Shared cache</p>
                    </div>
                  </div>
                  <div className="text-right text-sm text-gray-600">
                    <div className="font-mono text-gray-700">~10 cycles</div>
              ...
              {/* L3 Cache */}
              <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-4 rounded-xl ml-12 text-gray-700">
                <div className="flex items-center justify-between text-gray-700">
                  <div className="flex items-center space-x-3 text-gray-700">
                    <Zap className="w-6 h-6 text-gray-700" />
                    <div>
                      <h3 className="font-bold text-gray-800">L3 Cache</h3>
                      <p className="text-green-100 text-sm">Last level cache</p>
                    </div>
                  </div>
                  <div className="text-right text-sm text-gray-600">
                    <div className="font-mono text-gray-700">~30 cycles</div>
              ...
              <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4 rounded-xl text-white">
                <div className="flex items-center justify-between text-gray-700">
                  <div className="flex items-center space-x-3 text-gray-700">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-800">Main Memory (RAM)</h3>
                      <p className="text-blue-100 text-sm">System memory</p>
                    </div>
                  </div>
                  <div className="text-right text-sm text-gray-600">
                    <div className="font-mono text-gray-700">~200 cycles</div>
              ...
              {/* SSD */}
              <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-4 rounded-xl text-gray-700">
                <div className="flex items-center justify-between text-gray-700">
                  <div className="flex items-center space-x-3 text-gray-700">
                    <Database className="w-6 h-6 text-gray-700" />
                    <div>
                      <h3 className="font-bold text-gray-800">SSD Storage</h3>
                      <p className="text-purple-100 text-sm">Flash memory</p>
                    </div>
                  </div>
                  <div className="text-right text-sm text-gray-600">
                    <div className="font-mono text-gray-700">~25,000 cycles</div>
              ...
              {/* HDD */}
              <div className="bg-gradient-to-r from-gray-500 to-gray-600 text-white p-4 rounded-xl text-gray-700">
                <div className="flex items-center justify-between text-gray-700">
                  <div className="flex items-center space-x-3 text-gray-700">
                    <HardDrive className="w-6 h-6 text-gray-700" />
                    <div>
                      <h3 className="font-bold text-gray-800">Hard Disk (HDD)</h3>
                      <p className="text-gray-100 text-sm">Mechanical storage</p>
                    </div>
                  </div>
                  <div className="text-right text-sm text-gray-600">
                    <div className="font-mono text-gray-700">~10M cycles</div>
              ...
              <div className="bg-red-50 p-6 rounded-xl border border-red-200 text-gray-700">
                ...
                <div className="space-y-3 text-sm text-gray-600">
                  <div className="flex justify-between items-center text-gray-700">
                    ...
                    <span className="font-mono bg-red-100 px-2 py-1 rounded text-gray-600">3x slower</span>
                  </div>
                  <div className="flex justify-between items-center text-gray-700">
                    <span className="text-red-800">L1 Cache → RAM:</span>
                    <span className="font-mono bg-red-100 px-2 py-1 rounded text-gray-600">67x slower</span>
                  </div>
                  <div className="flex justify-between items-center text-gray-700">
                    <span className="text-red-800">RAM → SSD:</span>
                    <span className="font-mono bg-red-100 px-2 py-1 rounded text-gray-600">125x slower</span>
                  </div>
                  <div className="flex justify-between items-center text-gray-700">
                    <span className="text-red-800">SSD → HDD:</span>
                    <span className="font-mono bg-red-100 px-2 py-1 rounded text-gray-600">400x slower</span>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border text-gray-700">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 text-gray-700">
            {[
              {
                icon: Gauge,
                title: "Performance",
                ...
                <ul className={`space-y-1 text-xs text-${reason.color}-700`}>
                  {reason.examples.map((example, idx) => (
                    <li key={idx} className="flex items-start text-gray-700">
                      <span className="w-1 h-1 bg-current rounded-full mr-2 mt-1.5 text-gray-600"></span>
                      {example}
                    </li>
                  ))}
                </ul>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border text-gray-700">
          ...
          <div className="grid lg:grid-cols-2 gap-8 text-gray-700">
            <div className="space-y-6 text-gray-700">
              ...
              <div className="space-y-4 text-gray-700">
                <div className="bg-red-50 p-4 rounded-xl border border-red-200 text-gray-700">
                  ...
                  <div className="text-sm text-red-800 space-y-1">
                    ...
                    <p className="font-mono bg-red-100 px-2 py-1 rounded inline-block text-gray-700">O(n) - Linear time</p>
                  </div>
                </div>

                <div className="bg-green-50 p-4 rounded-xl border border-green-200 text-gray-700">
                  ...
                  <div className="text-sm text-green-800 space-y-1">
                    ...
                    <p className="font-mono bg-green-100 px-2 py-1 rounded inline-block text-gray-700">O(log n) - Logarithmic time</p>
                  </div>
                </div>
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <div className="space-y-4 text-gray-700">
                <div className="bg-yellow-50 p-4 rounded-xl border border-yellow-200 text-gray-700">
                  ...
                  <div className="text-sm text-yellow-800 space-y-2">
                    ...
                    <div className="font-mono bg-yellow-100 p-2 rounded text-gray-700">
                ...
                <div className="bg-orange-50 p-4 rounded-xl border border-orange-200 text-gray-700">
                  ...
                  <div className="text-sm text-orange-800 space-y-2">
                    ...
                    <div className="font-mono bg-orange-100 p-2 rounded text-xs text-gray-600">
                ...
                <div className="bg-purple-50 p-4 rounded-xl border border-purple-200 text-gray-700">
