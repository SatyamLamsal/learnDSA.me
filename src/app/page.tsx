        ...
        <section className="container mx-auto px-4 pb-8 text-gray-700">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 text-gray-700">
              ...
              <div className="mt-4 md:mt-0 flex items-center bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-3 rounded-2xl shadow-lg text-gray-700">
      ...
      <section className="relative pt-8 pb-20 overflow-hidden text-gray-700">
        ...
        <div className="relative container mx-auto px-4 text-gray-700">
          ...
          >
            ...
            <Link href="/learning-style-quiz" className="inline-block text-gray-700">
          ...
          {dataStructures.map((ds, index) => (
            ...
            >
              <CompletionCardWrapper
                topicId={ds.id}
                className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden h-full relative text-gray-700"
              >
                ...
                <Link href={ds.path} className="flex flex-col h-full text-gray-700">
                  <div className={`${ds.color} h-20 flex items-center justify-center`}>
                    <span className="text-3xl text-white font-bold text-gray-800">
                      {ds.icon}
                    </span>
                  </div>
            ...
            {algorithmCategories.map((category, index) => (
              ...
              >
                <Link href={category.path}>
                  <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group text-gray-700">
                    <div className={`${category.color} h-20 flex items-center justify-center`}>
                      <span className="text-3xl text-white font-bold text-gray-800">{category.icon}</span>
                    </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto text-gray-700">
          {features.map((feature, index) => (
            <motion.div
              ...
              transition={{ duration: 0.6, delay: index * 0.1 }}
              viewport={{ once: true }}
              className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden text-gray-700"
            >
        ...
        <div className="container mx-auto px-4 text-gray-700">
          ...
          <div className="max-w-4xl mx-auto text-gray-700">
            <motion.div
              ...
              className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden text-gray-700"
            >
              <div className="bg-blue-600 h-20 flex items-center justify-center text-gray-700">
                <div className="text-5xl text-white text-gray-700">{testimonials[currentTestimonial].avatar}</div>
              </div>
