...
interface ProtectedLearningPathProps {
  children: React.ReactNode;
}

export default function ProtectedLearningPath({ children }: ProtectedLearningPathProps) {
  ...
  useEffect(() => {
    if (status === 'unauthenticated') {
      router.push('/auth/signin?callbackUrl=/learning-path');
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Hey there! We&apos;ve got some solid DSA content ready for you, but we&apos;re still building out more awesome features. 
                Keep visiting us as we add new modules, interactive exercises, and cool stuff regularly!
              </p>
